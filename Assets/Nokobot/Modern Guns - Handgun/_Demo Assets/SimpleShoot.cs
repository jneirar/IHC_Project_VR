...
public class SimpleShoot : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        tempBullet.layer = LayerMask.NameToLayer("BulletsSlice");
        audioSource.Play();
        
        foreach (Transform child in tempBullet.transform)
            child.gameObject.layer = LayerMask.NameToLayer("BulletsSlice");
