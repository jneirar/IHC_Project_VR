...
{
    #region Singleton
    static ScoreManagerLevelTwo instance;
    public static ScoreManagerLevelTwo Instance { get { return instance; } }
    ...
    void Start()
    {
        finished = GameManager.Instance.getLevel2Completed();
        ...
        if(!finished)
        {
            ...
            pathController.SetActive(false);
            FruitsSpawner.SetActive(false);
    ...
    void Update() 
    {
        if(!finished)
        {
            ...
            if(score >= goalScore)
            {
                GameManager.Instance.setLevel2Completed(true);
                finished = true;
    ...
    IEnumerator Countdown(int seconds)
    {
        ...
        pathController.SetActive(true);
        FruitsSpawner.SetActive(true);
